...
void Estad1() {
  ...
  comida ();
  colision();
 //twxto de puntos en esquina derecha
fill (0);
...
void colision (){
  ...
  if (dist (x1+70, y1+90, posX+40, posY+40) < 30) {
    posX=200 ;
    posY=-10 ;
    p=p+1;
  }
  
  if (dist (x1+70, y1+90, posX1+40, posY1+40) < 30) {
    posX1= 420;
    posY1=-10 ;
    p=p+1;
  }
  if (dist (x1+70, y1+90, posX2+40, posY2+40) < 30) {
    posX2=47;
    posY2=-10 ;
    p=p+1;
  }
  if (dist (x1+70, y1+90, posX3+40, posY3+40) < 30) {
    posX3=300;
    posY3=-10 ;
    p=p+1;
  }
  if (dist (x1+70, y1+90, posX4+40, posY4+40) < 30) {
    posX4=480;
    posY4=-10 ;
    p=p+1;
  }
  ...
  if (dist (x1+70, y1+90, posX5+40, posY5+40) < 30) {
    Estado=3;
  }
    if (dist (x1+70, y1+90, posX6+40, posY6+40) < 30) {
    Estado=3;
    }
    if (dist (x1+70, y1+90, posX7+40, posY7+40) < 30) {
    Estado=3;
    }
  }
